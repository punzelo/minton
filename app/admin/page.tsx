    ...
    <PageContainer>
      <div className="mb-6 flex items-center justify-between gap-4">
        <div>
          ...
          <p className="mt-1 text-sm text-slate-500">현재 공개 대회 목록과 새 대회 생성 진입점을 보여줍니다.</p>
        </div>
        <Link
          className="inline-flex items-center gap-2 rounded-md bg-court-700 px-4 py-2 text-sm font-semibold text-white"
