  ...
  return (
    <form className="space-y-4" onSubmit={handleSubmit}>
      ...
      <label className="block text-sm font-medium text-slate-700">
        경기 방식
        <select className="mt-1 block w-full rounded-md border border-slate-300 bg-white px-3 py-2 text-sm" name="matchType" defaultValue="doubles">
      ...
      <Button type="submit">대회 만들기</Button>
    </form>
  );
}
